...
# Celery task sinh file PDF sao kê tài khoản

class StatementGenerationTask(Task):
    def on_failure(self, exc, task_id, args, kwargs, einfo):
        # Log lỗi khi task thất bại
...
def generate_statement_pdf(self, statement_data: dict, statement_id: str) -> dict:
    """Sinh file PDF sao kê và lưu tạm vào Redis."""
    try:
        ...
        # Thông tin người dùng & tài khoản
        user_info = [
        ...
        # Hiển thị bảng thông tin user + account
        ...
        if transactions:
            ...
            table_data = [["Date", "Reference", "Description", "Type", "Amount", "Balance"]]
